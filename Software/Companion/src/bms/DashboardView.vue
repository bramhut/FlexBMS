...
import { bmsFaultNames, bmsStateName, bmsStatusSummary, cellVoltageV, currentA, hvReasonNames, hvStateName, icCelsius, ntcCelsius, setBits, socPercent } from '@/shared/model'
...
const statusMessage = computed(() => bmsStatusSummary(props.status))
...
<template>
  <main class="dashboard">
    <section class="status-strip" :class="{ warning: !fresh }"><b>{{ fresh ? 'Telemetry fresh' : 'Telemetry unavailable' }}</b><span>{{ statusMessage }}</span></section>
