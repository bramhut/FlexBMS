...
const props = defineProps<{ transport: BmsTransport; capabilities: Capabilities; connected: boolean; acknowledgementPending: boolean; stm32UptimeMs?: number; gateway?: GatewayStatus }>()
const slave = ref(0)
