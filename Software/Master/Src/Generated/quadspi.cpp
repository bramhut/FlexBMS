...
void HAL_QSPI_MspInit(QSPI_HandleTypeDef* qspiHandle)
{
  ...
  */
    ...
    */
    GPIO_InitStruct.Pin = QSPI_SCK_Pin|QSPI_IO3_Pin|QSPI_IO2_Pin;
    ...
    GPIO_InitStruct.Pin = QSPI_IO1_Pin|QSPI_IO0_Pin|QSPI_NSS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF10_QUADSPI;
...
void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef* qspiHandle)
{
  ...
  /* USER CODE END QUADSPI_MspDeInit 0 */
    ...
    PB11     ------> QUADSPI1_BK1_NCS
    */
    HAL_GPIO_DeInit(GPIOA, QSPI_SCK_Pin|QSPI_IO3_Pin|QSPI_IO2_Pin);

    HAL_GPIO_DeInit(GPIOB, QSPI_IO1_Pin|QSPI_IO0_Pin|QSPI_NSS_Pin);
