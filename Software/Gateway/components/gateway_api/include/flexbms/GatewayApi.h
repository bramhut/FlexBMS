...
{
    enum class Service : uint8_t { SetRunRequest = 0x02U, AcknowledgeFaults = 0x03U, ReadRegister = 0x04U, SetRtc = 0x05U, GetDeviceInfo = 0x06U, GetRtc = 0x08U, SetBalancingEnabled = 0x09U, GetConfig = 0x0BU, SetConfig = 0x0CU };
