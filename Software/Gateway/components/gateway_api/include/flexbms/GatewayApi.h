...
{
    enum class Service : uint8_t { SetRunRequest = 0x02U, ClearFaults = 0x03U, ReadRegister = 0x04U, SetRtc = 0x05U, GetRtc = 0x08U };
    enum class ServiceResult : uint8_t { Ok = 0U, Denied = 1U, Invalid = 2U, TransportError = 3U, Busy = 4U };
